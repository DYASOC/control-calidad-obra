...
const FASES = [
  {
    ...
    rubros: [
      ...
      {
        id: "SANITARIAS", nombre: "Instalación Sanitaria y Gas",
        items: [
  ...
  },
  {
    id: "F2", nombre: "Fase 2",
    rubros: [
      { id: "REVOQUE_BC", nombre: "Revoque (Baños y Cocinas)", items: [
  ...
  },
  {
    id: "F3", nombre: "Fase 3",
    rubros: [
      { id: "CUBIERTAS2",    nombre: "Cubiertas",                          items: [] },
      ...
      { id: "ART_SAN_GRI",   nombre: "Artefactos Sanitarios y Grifería Baños", items: [] },
